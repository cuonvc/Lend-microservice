...
public class FileHandler {
    ...
    @Bean
    public Function<Message<FileObjectRequest>, Message<FileObjectResponse>> fileHandle() {
        return request -> {
            ...
            String imagePath = fileImageService.saveFile(key, value.getField(), value.getFileBytes());
